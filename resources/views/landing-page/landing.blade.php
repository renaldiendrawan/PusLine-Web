...
<head>
  ...
  <title>Selamat Datang di PUSLINE</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>PUSLINE</h1>
          <h2>Akses layanan periksa kesehatan Puskesmas di ujung jarimu. Jadwalkan periksa, dapatkan informasi kesehatan terkini, dan jaga kebugaranmu dengan mudah. </h2>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#about" class="btn-get-started scrollto">Mulai</a>
            <a href="https://www.youtube.com/watch?v=C2AmVFZLyf4&ab_channel=PuskesmasJatikalen" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i><span>Profil Puskesmas </span></a>
          </div>
        </div>
        ...
        <div class="container-fluid" data-aos="fade-up">
          ...
          <div class="row">
            ...
            <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
              ...
              <div class="content">
                <h3 style="text-align: center;"><strong>POLI PELAYANAN</strong></h3>
              </div>
  
              <div class="accordion-list">
                <ul>
                  <li>
                    <a data-bs-toggle="collapse" class="collapse" data-bs-target="#accordion-list-1"><span>01</span> Poli Umum <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  ...
                  <li>
                    ...
                    <div id="accordion-list-2" class="collapse" data-bs-parent=".accordion-list">
                      <p>
                        Pelayanan rawat jalan di bidang kesehatan yang menyangkut pelayanan dan pemeliharaan ibu hamil, ibu menyusui, bayi dan anak balita
                      </p>
                    </div>
                  </li>
                  <li>
                    ...
                    <div id="accordion-list-3" class="collapse" data-bs-parent=".accordion-list">
                      <p>
                        Pelayanan kesehatan gigi merupakan pemeriksaan kesehatan gigi, pengobatan dan pemberian tindakan medis dasar kesehatan gigi, seperti penambalan gigi, pencabutan gigi dan pembersihan karang gigi.
                      </p>
                    </div>
                  </li>
                  <li>
