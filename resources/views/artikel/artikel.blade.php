                                                ...
                                                <body>
                                                    <div class="search-container">
                                                        <div class="search-box">
                                                            <input type="text" placeholder="Cari Berdasarkan ID Artikel " id="searchInput">
                        ...
                        <script>
                            document.getElementById("searchButton").addEventListener("click", function() {
                                ...
                                tableRows.forEach(function(row) {
                                    var idArtikel = row.cells[0].innerText.toLowerCase(); // Mengambil nilai ID Artikel dari setiap baris tabel dan mengonversinya ke huruf kecil
                                    if (idArtikel.includes(searchTerm)) { // Memeriksa apakah nilai ID Artikel mengandung kata kunci pencarian
